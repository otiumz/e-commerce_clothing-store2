		...
		<div className='categories'>
			...
			<div className="col">
				<div className="row">
					...
					<button>
						<Link className='link' to='/prod'>New Season</Link>
					</button>
				</div>
			</div>
			<div className="col col-l">
				<div className="row">
					<div className="col">
						<div className="row">
							...
							<button>
								<Link className='link' to='/prod'>Men</Link>
							</button>
						</div>
					</div>
					<div className="col">
						<div className="row">
							...
							<button>
								<Link className='link' to='/prod'>Accessories</Link>
							</button>
						</div>
					</div>
				</div>
				<div className="row">
					...
					<button>
						<Link className='link' to='/prod'>Shoes</Link>
					</button>
				</div>
			</div>
		</div>
